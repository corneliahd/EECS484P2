...
SELECT P.PHOTO_ID, P.ALBUM_ID, A.ALBUM_NAME, P.PHOTO_CAPTION, P.PHOTO_LINK
FROM SYZHAO.PUBLIC_PHOTOS P, SYZHAO.PUBLIC_TAGS T1, SYZHAO.PUBLIC_TAGS T2, SYZHAO.PUBLIC_ALBUMS A
WHERE T1.TAG_SUBJECT_ID = 1315 AND T2.TAG_SUBJECT_ID = 1702
AND T1.TAG_PHOTO_ID = T2.TAG_PHOTO_ID
