...
SELECT DISTINCT
A.UID1, U1.FIRST_NAME, U1.LAST_NAME,
A.UID2, U2.FIRST_NAME, U2.LAST_NAME,
A.CommonFri
...
WHERE U1.USER_ID = A.UID1 AND U2.USER_ID = A.UID2 AND ROWNUM <= 5
ORDER BY A.CommonFri DESC, A.UID1 ASC, A.UID2 ASC;
